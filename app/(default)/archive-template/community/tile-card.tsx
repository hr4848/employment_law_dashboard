      ...
      <div className="flex flex-col h-full">
            ...
            <header>
              <div className="flex mb-2">
                ...
                <div className="mt-1 pr-1">
                  ...
                  <div className="flex items-center"><span className="text-sm font-medium text-gray-400 dark:text-gray-500 -mt-0.5 mr-1">-&gt;</span> <span>{user.location}</span></div>
                </div>
              </div>
            </header>
            {/* Menu button */}
        ...
        <div className="border-t border-gray-100 dark:border-gray-700/60">
          <div className="flex divide-x divide-gray-100 dark:divide-gray-700/60">
            <Link className="block flex-1 text-center text-sm text-violet-500 hover:text-violet-600 dark:hover:text-violet-400 font-medium px-3 py-4" href="/messages">
