...
export default function TaskDrawer({ task, onClose }: TaskDrawerProps) {
  ...
  return (
    <Dialog open={!!task} onClose={onClose} className="fixed inset-0 z-[9999]">
                ...
                <div className="flex-1">
                  ...
                  <div className="bg-gray-50 px-4 py-6 sm:px-6">
                    <div className="flex items-start justify-between space-x-3">
                      <div className="space-y-1">
                        ...
                        <p className="text-sm text-gray-500">Task details and supporting information.</p>
                      </div>
                  ...
                  <div className="space-y-6 py-6 sm:divide-y sm:divide-gray-200">
                    ...
                    <div className="space-y-2 px-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-5">
                      ...
                      <div className="sm:col-span-2">{getStatusBadge(task.status)}</div>
                    </div>
                    ...
                    {/* Additional Info */}
                    {[
                      ['Further Information', task.context],
                      ['Keywords Explained', task.keywords_explained],
                      ['Recommended Reading', task.linked_resources],
                      ['Notes', task.notes],
